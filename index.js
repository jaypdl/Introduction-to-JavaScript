...
Do the following:   
   ...
   HINT: no function required
*/
let variableValue = 'This is my initial value';
let variableValueChange = 'This is what it should change to';

if (variableValue != variableValueChange){
  variableValue = variableValueChange;
...
*/
function game(choice, userOverride){
